                ...
                <div class="flex flex-col w-full space-y-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" id="presentacion" name="presentacion"
                            value="{{ session('clear_fields') ? '' : old('presentacion', Auth::user()->presentacion) }}"
                    ...
                    <div class="w-full">
                        ...
                        <textarea id="biografia" name="biografia" rows="4"
                            class="w-full p-4 border-2 border-gray-300 rounded-md bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400">{{ session('clear_fields') ? '' : old('biografia', Auth::user()->biografia) }}</textarea>
                    </div>
                </div>
