...
<div class="flex-1 p-4 overflow-y-auto h-screen">
    ...
    <div class="bg-gray-100 rounded-lg shadow-lg overflow-hidden mb-4">
        <div class="flex flex-col md:flex-row">
            <img src="imagen-principal.jpg" alt="Noticia Principal" class="w-full md:w-1/2 object-cover">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        <div class="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
            <img src="imagen-noticia1.jpg" alt="Noticia 1" class="w-full object-cover">
            <div class="p-4">
        ...
        <div class="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
            <img src="imagen-noticia2.jpg" alt="Noticia 2" class="w-full object-cover">
            <div class="p-4">
        ...
        <div class="bg-gray-100 rounded-lg shadow-lg overflow-hidden">
            <img src="imagen-noticia3.jpg" alt="Noticia 3" class="w-full object-cover">
            <div class="p-4">
        ...
        <!-- Puedes agregar más tarjetas de noticia si es necesario -->
    </div>
</div>
@endsection