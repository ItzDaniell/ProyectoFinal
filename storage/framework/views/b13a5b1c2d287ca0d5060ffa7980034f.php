    ...
    <form id="photo-form" action="<?php echo e(route('usuario.actualizarFotoPerfil')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-7xl mx-auto">
            ...
            <!--[if BLOCK]><![endif]--><?php if(Auth::user()->profile_photo_path): ?>
                <button type="button" class="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition"
                        onclick="event.preventDefault(); document.getElementById('delete-photo-form').submit();">
                    Eliminar Foto de Perfil
                </button>
                <form id="delete-photo-form" action="<?php echo e(route('usuario.eliminarFotoPerfil')); ?>" method="POST" style="display: none;">
                    <?php echo csrf_field(); ?>
