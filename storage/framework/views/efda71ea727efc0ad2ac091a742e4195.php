...
<div class="flex justify-center items-center min-h-screen bg-gray-50 py-10">
    <div class="w-full max-w-4xl space-y-10">
        <form action="<?php echo e(route('usuario.actualizarPerfil')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
                ...
                <div class="mb-8 flex items-center justify-between w-full">
                    <div class="flex items-center">
                        <label for="profile_photo" class="cursor-pointer">
                            <img class="w-24 h-24 rounded-full object-cover mr-4 border-2 border-gray-300 hover:border-gray-500 transition"src="<?php echo e(Auth::user()->profile_photo_path? asset('storage/' . Auth::user()->profile_photo_path): (Auth::user()->avatar ?? 'https://via.placeholder.com/150')); ?>" alt="Foto de perfil">
                ...
                <div class="flex flex-col w-full space-y-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" id="presentacion" name="presentacion"
                            value="<?php echo e(session('clear_fields') ? '' : old('presentacion', Auth::user()->presentacion)); ?>"
                    ...
                    <div class="w-full">
                        ...
                        <textarea id="biografia" name="biografia" rows="4"
                            class="w-full p-4 border-2 border-gray-300 rounded-md bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-400"><?php echo e(session('clear_fields') ? '' : old('biografia', Auth::user()->biografia)); ?></textarea>
                    </div>
                </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2013170730-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2013170730-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2013170730-2', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('layouts.postiniciolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\davil\OneDrive\Desktop\ProyectoFinal\resources\views/PostInicioSesion/ConfiguracionPerfil.blade.php ENDPATH**/ ?>