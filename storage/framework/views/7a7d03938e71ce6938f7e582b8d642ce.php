...
<div class="min-h-screen flex flex-col items-center justify-center bg-gray-50 pt-16 p-8">
    ...
    <div class="max-w-4xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white p-8 rounded-lg shadow-xl">
        ...
        <div class="bg-orange-400 p-8 rounded-lg shadow-lg">
            ...
            <!-- Formulario -->
            <form action="<?php echo e(route('Contactanos.post')); ?>" method="POST" class="space-y-4">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\davil\OneDrive\Desktop\ProyectoFinal\resources\views/PreInicioSesion/Contactanos.blade.php ENDPATH**/ ?>