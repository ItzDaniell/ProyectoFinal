...
<div class="container mx-auto p-40">
    ...
    <section class="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div>
            <img src="<?php echo e(asset('images/contactanos.jpg')); ?>" alt="Imagen de soporte" class="rounded-lg shadow-lg w-full h-120 object-cover">
        </div>
    </section>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\davil\OneDrive\Desktop\ProyectoFinal\resources\views/PreInicioSesion/FAQ.blade.php ENDPATH**/ ?>