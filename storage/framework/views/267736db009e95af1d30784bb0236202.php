                    ...
                    <div class="flex items-center">
                        <label for="profile_photo" class="cursor-pointer">
                            <img class="w-24 h-24 rounded-full object-cover mr-4"
                                src="<?php echo e(Auth::user()->profile_photo_path ? asset('storage/' . Auth::user()->profile_photo_path) : 'https://via.placeholder.com/150'); ?>"
                                alt="Foto de perfil">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2750571777-3', $__slots ?? [], get_defined_vars());
