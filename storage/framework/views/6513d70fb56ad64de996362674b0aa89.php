        ...
        <?php switch(config('adminlte.laravel_asset_bundling', false)):
            ...
            <?php default: ?>
                ...
                <?php if(config('adminlte.google_fonts.allowed', true)): ?>
                    <link rel="stylesheet" href='https://fonts.googleapis.com/css2?family=AR+One+Sans:wght@400..700&family=Nunito:ital,wght@0,200..1000;1,200..1000&display=swap'>
                <?php endif; ?>
        <?php endswitch; ?>
    <?php endif; ?>
...
<?php /**PATH C:\Users\davil\OneDrive\Desktop\ProyectoFinal\vendor\jeroennoten\laravel-adminlte\src/../resources/views/master.blade.php ENDPATH**/ ?>