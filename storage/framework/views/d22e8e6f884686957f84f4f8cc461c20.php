        ...
        <div class="flex space-x-4 relative">
            <div class="relative">
                ...
                <div id="searchDropdown" class="hidden absolute right-0 w-96 mt-2 bg-white shadow-lg rounded-lg p-4">
                    ...
                    <form action="<?php echo e(route('Home')); ?>" method="get" class="flex">
            ...
            <div class="relative">
                ...
                <div id="filterDropdown" class="hidden absolute right-0 w-80 mt-2 bg-white shadow-lg rounded-lg p-4">
                    <div class="flex flex-col space-y-2">
                        ...
                        <form action="<?php echo e(route('Home')); ?>" method="get" class="flex flex-col space-y-3">
    ...
    <div class="max-w-lg mx-auto bg-gray-100 rounded-lg shadow-lg mb-6 mb-4">
        <div class="flex items-center justify-between p-4 bg-gray-200 rounded-t-lg">
            <div class="flex items-center space-x-3">
                ...
                <div>
                    <p class="text-sm font-medium"><?php echo e($publicacion->users->name); ?></p>
                    <p class="text-xs text-gray-600">Publicado: <?php echo e($publicacion->created_at->diffForHumans()); ?></p>
                </div>
            </div>
        ...
        <div class="bg-gray-100">
            <img src="<?php echo e(asset('storage/' . $publicacion->imagen)); ?>" alt="Imagen de la Publicación" 
                class="w-full max-h-96 object-cover border border-gray-300">
        </div>
        <?php endif; ?>
        <div class="p-4">
            <h3 class="text-lg font-bold"><?php echo e($publicacion->titulo); ?></h3>
            <p class="text-sm text-gray-600">
                <?php echo e($publicacion->categoria->descripcion); ?>
...
<?php echo $__env->make('layouts.postiniciolayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\davil\OneDrive\Desktop\ProyectoFinal\resources\views/PostInicioSesion/Home.blade.php ENDPATH**/ ?>